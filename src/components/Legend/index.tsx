...
const items = [
  ...
  { color: '#990000', label: '0.8-0.3' },
  { color: '#000000', label: 'до 0.3' },
];
  ...
  return (
    <aside className="legend">
      <h4>Інтенсивність пожеж</h4>
       <p className="legend-item">Кількість палива, що залишилось на ділянці, де 1 це відсутність пожежі, а менше 0.3 все згоріло</p>
      {items.map(item => (
